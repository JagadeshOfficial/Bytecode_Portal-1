            ...
            <div ref={brochureRef}>
                ...
                <section className={styles.page}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem' }}>
                        ...
                        <img src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=500&auto=format&fit=crop" style={{ borderRadius: '20px', width: '100%' }} />
                    </div>
                </section>
                    ...
                    <div className={styles.roadmapPage}>
                        ...
                        <div className={styles.roadmapSplit}>
                            ...
                            <div className={styles.roadmapImageFrame}>
                                <img src="https://images.unsplash.com/photo-1549419137-3375c3f7652c?q=80&w=600&auto=format&fit=crop" alt="Hacker" />
