    ...
    return (
        <DashboardLayout role="student">
            <div style={{ marginBottom: '2rem' }}>
                ...
                <p style={{ color: 'var(--text-secondary)' }}>Track your progress and prepare for placements.</p>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                ...
                >
                    <div>
                        ...
                        <p style={{ color: 'var(--text-secondary)', marginBottom: '1rem' }}>Java Full Stack Development</p>
                ...
                >
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        <div style={{ padding: '1rem', background: 'rgba(37, 99, 235, 0.1)', borderRadius: '1rem', borderLeft: '4px solid var(--primary)' }}>
                            ...
                            <div style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>Tomorrow, 10:00 AM • Auditorium</div>
                        </div>
                        <div style={{ padding: '1rem', background: 'rgba(255,255,255,0.02)', borderRadius: '1rem', borderLeft: '4px solid var(--text-muted)' }}>
                            <div style={{ fontWeight: 'bold', marginBottom: '0.25rem' }}>System Maintenance</div>
                            <div style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>LMS will be down on Sunday 2 AM - 4 AM.</div>
                        </div>
                    </div>
                </motion.div>
            </div>
