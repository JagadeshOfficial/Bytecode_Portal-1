...
public class DataSeeder implements CommandLineRunner {
    ...
    private void clearAllData() {
        ...
        log.info("Cleared all existing academic data");
    }
    ...
    private void seedAssignments() {
        ...
        List<Assignment> assignments = Arrays.asList(
            ...
            Assignment.builder()
                ...
                .instructions("Use scikit-learn, perform data preprocessing, feature engineering, and model evaluation")
                .submissions(new ArrayList<>())
                .status("ACTIVE")
                .createdAt(getDate(-3))
                .build(),
            ...
            Assignment.builder()
                ...
                .totalMarks(50)
                .difficulty("EASY")
                .attachments(Arrays.asList("https://aws.amazon.com/getting-started/hands-on/host-static-website/"))
                .instructions("Create S3 bucket, configure static website hosting, and set up CloudFront distribution")
                .submissions(new ArrayList<>())
                .status("ACTIVE")
                .createdAt(getDate(-2))
                .build(),
            ...
            Assignment.builder()
                ...
                .totalMarks(75)
                .difficulty("MEDIUM")
                .attachments(Arrays.asList("https://docs.python-requests.org/", "https://www.crummy.com/software/BeautifulSoup/"))
                .instructions("Use BeautifulSoup and Requests library, handle pagination, and store data in CSV")
                .submissions(new ArrayList<>())
                .status("CLOSED")
                .createdAt(getDate(-7))
                .build(),
            ...
            Assignment.builder()
                ...
                .instructions("Implement CRUD operations, exception handling, validation, and Swagger documentation")
                .submissions(new ArrayList<>())
                .status("ACTIVE")
                .createdAt(getDate(-4))
                .build()
                ...
                .modules(Arrays.asList(
                    Curriculum.Module.builder()
                        ...
                        .topics(Arrays.asList(
                            Curriculum.Topic.builder().topicId("t1").topicName("React Basics").order(1).duration(8).content("Components, Props, State").resources(Arrays.asList("https://reactjs.org/docs")).isCompleted(false).build(),
                            Curriculum.Topic.builder().topicId("t2").topicName("React Hooks").order(2).duration(8).content("useState, useEffect, useContext").resources(Arrays.asList("https://reactjs.org/docs/hooks-intro.html")).isCompleted(false).build(),
                            Curriculum.Topic.builder().topicId("t3").topicName("React Router").order(3).duration(6).content("Client-side routing").resources(Arrays.asList("https://reactrouter.com/")).isCompleted(false).build(),
                            Curriculum.Topic.builder().topicId("t4").topicName("State Management").order(4).duration(10).content("Redux, Context API").resources(Arrays.asList("https://redux.js.org/")).isCompleted(false).build(),
                            Curriculum.Topic.builder().topicId("t5").topicName("API Integration").order(5).duration(8).content("Axios, Fetch API").resources(Arrays.asList("https://axios-http.com/")).isCompleted(false).build()
                        ))
                        .learningOutcomes(Arrays.asList("Build responsive UIs", "Manage application state", "Integrate with REST APIs"))
                        .build(),
                    Curriculum.Module.builder()
                        .moduleId("mod-2")
                        ...
                        .topics(Arrays.asList(
                            Curriculum.Topic.builder().topicId("t6").topicName("Node.js Fundamentals").order(1).duration(8).content("Event Loop, Modules, NPM").resources(Arrays.asList("https://nodejs.org/docs")).isCompleted(false).build(),
                            Curriculum.Topic.builder().topicId("t7").topicName("Express.js Framework").order(2).duration(10).content("Routing, Middleware, Error Handling").resources(Arrays.asList("https://expressjs.com/")).isCompleted(false).build(),
                            Curriculum.Topic.builder().topicId("t8").topicName("RESTful API Design").order(3).duration(8).content("HTTP Methods, Status Codes, Best Practices").resources(Arrays.asList()).isCompleted(false).build(),
                            Curriculum.Topic.builder().topicId("t9").topicName("Authentication & Authorization").order(4).duration(9).content("JWT, OAuth, Session Management").resources(Arrays.asList("https://jwt.io/")).isCompleted(false).build()
                        ))
                        .learningOutcomes(Arrays.asList("Create RESTful APIs", "Implement authentication", "Handle errors gracefully"))
                        .build(),
                    Curriculum.Module.builder()
                        .moduleId("mod-3")
                        ...
                        .topics(Arrays.asList(
                            Curriculum.Topic.builder().topicId("t10").topicName("MongoDB Basics").order(1).duration(6).content("Collections, Documents, CRUD Operations").resources(Arrays.asList("https://www.mongodb.com/docs/")).isCompleted(false).build(),
                            Curriculum.Topic.builder().topicId("t11").topicName("Mongoose ODM").order(2).duration(8).content("Schemas, Models, Validation").resources(Arrays.asList("https://mongoosejs.com/")).isCompleted(false).build(),
                            Curriculum.Topic.builder().topicId("t12").topicName("Advanced Queries").order(3).duration(6).content("Aggregation, Indexing, Performance").resources(Arrays.asList()).isCompleted(false).build(),
                            Curriculum.Topic.builder().topicId("t13").topicName("Database Design").order(4).duration(5).content("Schema Design, Relationships").resources(Arrays.asList()).isCompleted(false).build()
                        ))
                        .learningOutcomes(Arrays.asList("Design database schemas", "Perform complex queries", "Optimize database performance"))
                        .build()
                ))
                .totalDuration(100)
                .level("INTERMEDIATE")
            ...
            Curriculum.builder()
                ...
                .modules(Arrays.asList(
                    Curriculum.Module.builder()
                        ...
                        .topics(Arrays.asList(
                            Curriculum.Topic.builder().topicId("ds-t1").topicName("NumPy").order(1).duration(8).content("Arrays, Operations, Broadcasting").resources(Arrays.asList("https://numpy.org/doc/")).isCompleted(false).build(),
                            Curriculum.Topic.builder().topicId("ds-t2").topicName("Pandas").order(2).duration(12).content("DataFrames, Data Cleaning, Manipulation").resources(Arrays.asList("https://pandas.pydata.org/docs/")).isCompleted(false).build(),
                            Curriculum.Topic.builder().topicId("ds-t3").topicName("Matplotlib & Seaborn").order(3).duration(10).content("Data Visualization").resources(Arrays.asList("https://matplotlib.org/", "https://seaborn.pydata.org/")).isCompleted(false).build()
                        ))
                        .learningOutcomes(Arrays.asList("Analyze data with Python", "Create visualizations", "Clean and preprocess data"))
                        .build(),
                    Curriculum.Module.builder()
                        .moduleId("ds-mod-2")
                        ...
                        .topics(Arrays.asList(
                            Curriculum.Topic.builder().topicId("ds-t4").topicName("Supervised Learning").order(1).duration(15).content("Regression, Classification").resources(Arrays.asList("https://scikit-learn.org/")).isCompleted(false).build(),
                            Curriculum.Topic.builder().topicId("ds-t5").topicName("Unsupervised Learning").order(2).duration(12).content("Clustering, Dimensionality Reduction").resources(Arrays.asList()).isCompleted(false).build(),
                            Curriculum.Topic.builder().topicId("ds-t6").topicName("Model Evaluation").order(3).duration(8).content("Metrics, Cross-Validation, Hyperparameter Tuning").resources(Arrays.asList()).isCompleted(false).build(),
                            Curriculum.Topic.builder().topicId("ds-t7").topicName("Feature Engineering").order(4).duration(5).content("Feature Selection, Transformation").resources(Arrays.asList()).isCompleted(false).build()
                        ))
                        .learningOutcomes(Arrays.asList("Build ML models", "Evaluate model performance", "Optimize models"))
                        .build()
                ))
                .totalDuration(70)
                .level("ADVANCED")
    ...
    private void seedAnnouncements() {
        ...
        List<Announcement> announcements = Arrays.asList(
            Announcement.builder()
                ...
                .content("We are excited to announce a new batch for DevOps Engineering starting from next week. Limited seats available!")
                .type("EVENT")
                .priority("HIGH")
                .targetAudience("ALL")
            ...
            Announcement.builder()
                ...
                .content("The institute will remain closed on 26th January 2024 for Republic Day. All classes scheduled for that day are postponed.")
                .type("HOLIDAY")
                .priority("CRITICAL")
                .targetAudience("ALL")
                .targetBatchIds(new ArrayList<>())
            ...
            Announcement.builder()
                ...
                .content("The deadline for the MERN Stack Todo App assignment has been extended by 3 days due to technical issues.")
                .type("GENERAL")
                .priority("MEDIUM")
            ...
            Announcement.builder()
                ...
                .content("A placement drive is scheduled for next month with top tech companies. Students from Full Stack, Data Science, and AWS batches are eligible.")
                .type("EVENT")
                .priority("HIGH")
            ...
            Announcement.builder()
                ...
                .content("The learning portal will undergo scheduled maintenance on Sunday from 2 AM to 6 AM. Services will be temporarily unavailable.")
                .type("URGENT")
                .priority("CRITICAL")
                .targetAudience("ALL")
                .targetBatchIds(new ArrayList<>())
    ...
    private void seedNotices() {
        ...
        List<Notice> notices = Arrays.asList(
            ...
            Notice.builder()
                ...
                .content("Join us for a guest lecture by a senior software architect from Google on Saturday at 3 PM.")
                .priority("MEDIUM")
                .targetAudience("ALL")
            ...
            Notice.builder()
                ...
                .content("Please take a moment to fill out the course feedback survey. Your input helps us improve.")
                .priority("LOW")
                .targetAudience("STUDENTS")
