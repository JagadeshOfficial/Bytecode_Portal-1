        ...
        <div className={styles.brochureContainer}>
            <nav className={styles.nav}>
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                    ...
                    <button className={styles.exitBtn} style={{ background: '#f39200' }} onClick={() => router.push('/payment?course=DevOps&fee=35000')}>Enroll Now</button>
                </div>
            </nav>
            ...
            <div ref={brochureRef}>
                ...
                <section className={styles.page}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem' }}>
                        ...
                        <Image src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=500&auto=format&fit=crop" alt="Cover Image" style={{ borderRadius: '20px', width: '100%' }} width={600} height={400} />
                    </div>
                </section>
                    ...
                    <div className={styles.roadmapPage}>
                        ...
                        <div className={styles.roadmapSplit}>
                            ...
                            <div className={styles.roadmapImageFrame}>
                                <Image src="https://images.unsplash.com/photo-1601597111158-2fceff292cdc?q=80&w=600&auto=format&fit=crop" alt="Cloud Ops" width={600} height={400} />
                    ...
                    <div className={styles.zenithGrid}>
                        ...
                        <div className={styles.zenithContactStack}>
                            ...
                            <button className={styles.zenithAction} onClick={() => {
                                const message = encodeURIComponent("Hi Bytecode! I'm interested in the DevOps & Cloud Master course. Can you share more details?");
                ...
                <RelatedCourses currentPath="/brochure/devops-cloud" />
            </div>
        </div>
    );
}
