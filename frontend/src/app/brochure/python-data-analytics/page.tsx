        ...
        <div className={styles.brochureContainer}>
            <nav className={styles.nav}>
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                    <button className={styles.exitBtn} style={{ background: '#f39200' }} onClick={() => router.push('/payment?course=Python+Data+Analytics&fee=45000')}>Enroll Now</button>
                </div>
            </nav>
            ...
            <div>
                ...
                <section data-pdf-page="true" className={styles.heroPage}>
                    ...
                    <div className={styles.mainVerticalContent}>
                        ...
                        <div className={styles.masterHeadline}>
                            ...
                            <p>
                                Gain the skills to analyze, visualize, and interpret data to solve real business problems.
                                Perfect for beginners and aspiring data professionals.
                            </p>
                        </div>
                ...
                <section data-pdf-page="true" className={styles.page}>
                    ...
                    <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
                        <h2 style={{ fontSize: '3rem', color: 'var(--primary)', fontWeight: 900 }}>Your Complete Data Journey</h2>
                        ...
                        <div className={styles.whyPanelLuxury}>
                            ...
                            <div className={styles.luxuryImageWrapper}>
                                ...
                                <div className={styles.luxuryImageFrame}>
                                    ...
                                    />
                                    <div className={styles.achievementTag}>Your First Step</div>
                                </div>
                            </div>
                        </div>
                                ...
                                {[
                                    {
                                        i: Globe,
                                        t: "Industry Ready",
                                        d: "Learn the exact skills companies are looking for."
                                    },
                                    {
                                        i: ShieldCheck,
                                        t: "Strong Foundations",
                                        d: "Build robust applications from day one."
                                    },
                                    {
                                        i: Users,
                                        t: "Interview Practice",
                                        d: "Master your interviews with guided mock sessions."
                                    }
                                ].map((feat, i) => (
                ...
                <section data-pdf-page="true" className={styles.page}>
                    ...
                    <div className={styles.curriculumUniverse}>
                        <div className={styles.curriculumHeader}>
                            ...
                            <p>Learn the tools that companies actually use.</p>
                        </div>
                ...
                <section data-pdf-page="true" className={styles.page}>
                    ...
                    <div className={styles.wreathGrid}>
                        {[
                            ...
                            { name: "Phani B", company: "Centelon Networks", pkg: "3.5", image: "/placements/Phani.png" },
                ...
                <RelatedCourses currentPath="/brochure/python-data-analytics" />
            </div>
        </div>
    );
}
