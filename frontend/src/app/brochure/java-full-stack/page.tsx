        ...
        <div className={styles.brochureContainer}>
            <nav className={styles.nav}>
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                    ...
                    <button className={styles.exitBtn} style={{ background: '#f39200' }} onClick={() => router.push('/payment?course=Java+Full+Stack&fee=45000')}>Enroll Now</button>
                </div>
            </nav>
            ...
            <div ref={brochureRef}>
                ...
                <section className={styles.heroPage}>
                    ...
                    <div className={styles.mainVerticalContent}>
                        ...
                        <div className={styles.masterHeadline}>
                            ...
                            <p>
                                Gain the skills to build secure, scalable applications from front to back.
                                Perfect for beginners and aspiring software engineers.
                            </p>
                        </div>
                ...
                <section className={styles.page}>
                    ...
                    <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
                        <h2 style={{ fontSize: '3rem', color: 'var(--primary)', fontWeight: 900 }}>Your Complete Java Journey</h2>
                ...
                <RelatedCourses currentPath="/brochure/java-full-stack" />
            </div>
        </div>
    );
}
