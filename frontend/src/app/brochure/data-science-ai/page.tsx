...
export default function DataScienceBrochure() {
    ...
    return (
        <div className={styles.brochureContainer}>
            ...
            <div ref={brochureRef}>
                ...
                <section className={styles.heroPage}>
                    ...
                    <div className={styles.mainVerticalContent}>
                        ...
                        <div className={styles.masterHeadline}>
                            <h2>DATA SCIENCE & <br /> AI Masterclass</h2>
                            <p>
                                Master the Future of Intelligence.
                                From Statistical Analysis to Generative AI & Large Language Models.
                            </p>
                        </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem' }}>
                        <div>
                            <p style={{ fontSize: '1.2rem', lineHeight: 1.8, marginBottom: '2rem' }}>
                                Bytecode Trainings & Placements offers India's most advanced Data Science & AI curriculum.
                                Our program transforms beginners into Data Scientists and AI Engineers capable of building
                                complex predictive models and Generative AI applications.
                            </p>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                                {[
                                    { t: "Future Ready", d: "Learn Generative AI & LLMs." },
                                    { t: "Real Datasets", d: "Work with Kaggle & Industry data." },
                    ...
                    <div className={styles.futurePageWrapper}>
                        ...
                        <div className={styles.insightGrid}>
                            <div className={styles.insightCard}>
                                ...
                                <h3>High Demand</h3>
                                <p>AI & Data Science rules the job market with 40% YoY growth in openings.</p>
                            </div>
                            <div className={styles.insightCard}>
                                <div className={styles.insightIconBox}><Award size={40} /></div>
                                <h3>Salary Packages</h3>
                                <p>Data Scientists command premium salaries starting from 10 LPA to 35 LPA+.</p>
                            </div>
                            <div className={styles.insightCard}>
                        ...
                        <div className={styles.whyPanelLuxury}>
                            <div className={styles.whyContent}>
                                ...
                                <div className={styles.benefitGrid}>
                                    {[
                                        "Master GenAI, LLMs & Deep Learning",
                                ...
                                {[
                                    {
                                        ...
                                        d: "Strong foundation in Python programming, Math, and Statistics essential for Data Science.",
                                        c: "#003087"
                                    },
                                    {
                                        n: "02",
                                        t: "Machine Learning Core",
                                    ...
                                    },
                                    {
                                        n: "03",
                                        t: "Deep Learning & AI",
                                        d: "Neural networks, Computer Vision, NLP, and cutting-edge Generative AI models.",
                                        c: "#d63031"
                                    },
                                    {
                                        n: "04",
                        ...
                        <div className={styles.skillCategoryWrap}>
                            ...
                            <div className={styles.skillGrid}>
                                {[
                                    ...
                                    { s: 'TensorFlow', p: 'tensorflow/tensorflow-original.svg' },
                                    { s: 'PyTorch', p: 'pytorch/pytorch-original.svg' },
                        ...
                        <div className={styles.curriculumGrid}>
                            {[
                                ...
                                },
                                {
                                    n: "03",
                                    t: "Data Manipulation",
                                    p: ["NumPy Arrays & Matrices", "Pandas DataFrames", "Data Cleaning/Wrangling", "EDA Techniques"],
                                    tech: ["Pandas", "NumPy"]
                                },
                                {
                                    n: "04",
                            ...
                            {[
                                {
                                    n: "09",
                                    t: "Neural Networks",
                                    p: ["ANN Fundamentals", "Backpropagation", "Activation Functions", "TensorFlow/Keras"],
                                    tech: ["DL", "Keras"]
                                },
                                {
                                    n: "10",
                    ...
                    <div className={styles.curriculumUniverse}>
                        <div className={styles.trainerWrapLuxury}>
                            <div className={styles.trainerInfo}>
                                ...
                                <p>Learn from Data Scientists from top product companies.</p>
                                <div className={styles.trainerPillars}>
                                    {[
                                        ...
                                        { h: "Kaggle Grandmasters", d: "Learn winning strategies." },
                            ...
                            <div className={styles.testimonialsBlock}>
                                ...
                                <div className={styles.testimonialsHorizontalGrid}>
                                    ...
                                    {[
                                        ...
                                        { name: "Suresh P.", role: "Data Scientist @ Cognizant", text: "From zero Python knowledge to a Data Scientist. Bytecode made it possible.", star: 5 },
                                        { name: "Anil K.", role: "AI Engineer @ Absolute Labs", text: "The Deep Learning modules are intensive and industry relevant.", star: 5 }
                                    ].map((t, i) => (
                ...
                <section className={styles.page}>
                    ...
                    <div className={styles.roadmapConduit}>
                        ...
                        {[
                            {
                                weeks: "0-4",
                                tech: ["Python Fundamentals", "NumPy & Pandas", "Data Visualization", "Exploratory Analysis"],
                            ...
                            {
                                weeks: "9-12",
                                tech: ["Deep Learning (ANN/CNN)", "NLP Basics", "Computer Vision", "TensorFlow/Keras"],
                                soft: ["Project Storytelling", "Research Reading", "Agile Methodology"]
                            },
                            {
                                weeks: "13+",
                                tech: ["Generative AI & LLMs", "Cloud Deployment", "Capstone Project", "Mock Interviews"],
                    ...
                    <div className={styles.zenithGrid}>
                        ...
                        <div className={`${styles.zenithCard} ${styles.primary}`}>
                            ...
                            <div className={styles.zenithFeatureList}>
                                <div className={styles.zenithFeature}>
                                    ...
                                    <span>Complete Data Science & AI Course</span>
                                </div>
                                <div className={styles.zenithFeature}>
                                    <div className={styles.zenithCheck}><Check size={16} /></div>
                        ...
                        <div className={styles.zenithContactStack}>
                            ...
                            <button className={styles.zenithAction} onClick={() => {
                                const message = encodeURIComponent("Hi Bytecode! I'm interested in the Data Science & AI Master course. Can you share more details?");
                ...
                <RelatedCourses currentPath="/brochure/data-science-ai" />
            </div >
        </div >
    );
}
